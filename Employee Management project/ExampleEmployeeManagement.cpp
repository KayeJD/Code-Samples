...
void Employee::DisplayRecord(){
    ...
    cout << setw(5) << EmpID << setw(15) << EmpName << setw(15) << Post << setw(15) << Department << setw(8) << Salary << endl;
}
    ...
    do{
        ...
        switch(option){
            ...
            case '5':
                ...
                file.clear();
                int location=(recordNo1-1)*sizeof(e);
            ...
            case '6':
                int recordNo2=0;
                cout << "Enter employment ID to be deleted:" << endl;
                cin >> ID;
                isFound=0;
                file.seekg(0,ios::beg);
                file.read((char*)&e,sizeof(e));
